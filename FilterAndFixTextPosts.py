...
insta_text_df = pd.read_csv(INSTA_POST_FILE_PATH, encoding="utf-8")
...
twita_text_df.to_csv(TWITTTER_POST_FILE_PATH, encoding="utf-8")
insta_text_df.to_csv(INSTA_POST_FILE_PATH, encoding="utf-8")
